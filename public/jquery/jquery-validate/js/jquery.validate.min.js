...
if(idioma_sitio == 'en')
{
    ...
    jQuery.extend(jQuery.validator.messages, {
      ...
      email: "Please, write an email address.",
      url: "Please, write a valid url.",
      date: "Please, write a valid date.",
      dateISO: "Please, write a date (ISO) valid.",
      number: "Please, just numbers.",
      digits: "Please, just digits.",
      creditcard: "Please, write a valid credit card number.",
      equalTo: "Please, write the equal value.",
      accept: "Please.",
      maxlength: jQuery.validator.format("Por favor, no escribas m&aacute;s de {0} caracteres."),
      minlength: jQuery.validator.format("Por favor, no escribas menos de {0} caracteres."),
      rangelength: jQuery.validator.format("Por favor, escribe un valor entre {0} y {1} caracteres."),
